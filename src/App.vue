<template>
  <div class="flexible-content">
    ...
    <mdb-navbar class="flexible-navbar white" light position="top" scrolling>
      <mdb-navbar-brand href="https://mdbootstrap.com/docs/vue/" target="_blank">Brand</mdb-navbar-brand>
      <mdb-navbar-toggler>
        <mdb-navbar-nav left>
          <mdb-nav-item to="/" waves-fixed active class="active">Home</mdb-nav-item>
          <mdb-nav-item href="#" waves-fixed>Item 1</mdb-nav-item>
          <mdb-nav-item href="#" waves-fixed>Item 2</mdb-nav-item>
          <mdb-nav-item href="#" waves-fixed>Item 3</mdb-nav-item>
        </mdb-navbar-nav>
    ...
    <div class="sidebar-fixed position-fixed">
      <a class="logo-wrapper"><img alt="" class="img-fluid" src="./assets/ttg.png"/></a>
